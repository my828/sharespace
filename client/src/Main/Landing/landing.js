    ...
    return (
      <div id="landing-page-content">
            ...
            <div class="row">
              <div class="col-12 col-md-6">
                ...
                <p class="font-light pb-2 h5">
                  ...
                  houses are hard to access, have rigorous screening processes,
                  and are simply at full capacity. Our tool builds a community
                  of support to provide immediate, flexible housing to survivors
                  in urgent need.
                </p>
                <p class="font-light pb-2 h5">
                  Our team works closely with your nonprofit to take out the
                  bureaucracy, wait time, and lack of integration out of housing
                  resource planning by providing this easy-to-use platform to
                  dynamically find and book spaces for those who need it.
                </p>
        ...
        <section id="who-we-work-with">
          ...
          <p class="font-light">
            We're always looking to learn from experts in the causes we support.
            That's why we've partnered with organizations, both global and
            local, to truly understand the communities we serve and how to best
            help them. These registered nonprofits utilize Open Homes to find
            accomodations for their clients to help provide support for hosts
            during a stay.
          </p>
          <div class="contents">
            ...
            <div className="wwww-card">
              ...
              <div>
                ...
                <p class="font-light">
                  We developed a close working relationship with API Chaya as a
                  key part of our research and product development. API Chaya
                  connected us with hosts and advocates to review our product as
            ...
            <div className="wwww-card">
              ...
              <div>
                ...
                <p class="font-light">
                  ...
                  advocates and visitors of the day shelter to receive critical
                  feedback on the direction of our project.
                </p>
              </div>
            </div>
            <div className="wwww-card">
              ...
              <div>
                ...
                <p class="font-light">
                  ...
                  volunteer with them, attend their annual luncheon and connect
                  with their housing advocates.
                </p>
              </div>
            </div>
          </div>
        ...
        <section id="hwsy">
            ...
            <div className="slide">
              ...
              <div class="">
                ...
                <p class="font-light">
                  ...
                  organizations are vetted before joining our platform. All must
                  meet safety qualifications before being considered for a
                  homestay.
                </p>
              </div>
            </div>
            ...
            <div class="slide">
              ...
              <div class="">
                ...
                <p class="font-light">
                  ...
                  possible, so it's our priority to make sure your needs are met
          ...
          {/* <div class="">
            ...
            <div>
              <div class="">
                <img src={Check} class="" alt="..." />
                <div class="">
                  <h5 class="">Screenings and Checks</h5>
                  <p class="font-light">
                    Background checks will be conducted on guests and local
              ...
              <div class="">
                <img class="" alt="..." src={Meet} />
                <div class="">
                  <p class="">Connecting with an Advocate</p>
                  <p class="font-light">
                    Before any stay, advocates from the local organization we
                    partner with will personally handle the booking,
                    communications, needs-assessment, and cultural preferences
              ...
              <div class="">
                <img class="" alt="..." src={Online} />
                <div class="">
                  <p class="">Online Support and Resources</p>
                  <p class="font-light">
                    We have your back. Our platform supports a 24/7 chat service
                    that is available to you, in addition to the local
                    organization leader who will be your main point of contact.
